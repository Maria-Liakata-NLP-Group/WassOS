...
class PositionFeatExtractor(nn.Module):
    ...
    def desc(self):
        if self.feat_type == 1:
            ...
            return "FEAT 3: TGT -> Self-ATT -> TGT-ENC-ATT"
...
class PositionPredictor(nn.Module):
    ...
    Pred 3: relative position regression [0,M]
    """
    ...
    def desc(self):
        if self.pred_type == 1:
            ...
            return "PRED 3: Relative Position Value Regression"
        else:
            raise RuntimeError("illegal selection")
