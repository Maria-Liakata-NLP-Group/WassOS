...
class RunHP(BaseHP):
    ...
    def __init__(self):
        ...
        self.words_vocab_fp = f'{self.root_path}/artifacts/{self.dataset}/data/vocab.txt'
        self.tag_vocab_fp = f'{self.root_path}/artifacts/{self.dataset}/data/tag.txt'
