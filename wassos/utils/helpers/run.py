# contains functions associated with runs scripts #
import os
from logging import getLogger
from mltoolkit.mlutils.helpers.paths_and_files import get_file_name, comb_paths
from wassos.eval.procedures import SummEvalProc
...
def summ_eval(output_folder, data_pipeline, eval_data_source, summ_gen_func,
    ...
    logger.info("Performing the summary.csv evaluation on %s." % eval_data_source)
