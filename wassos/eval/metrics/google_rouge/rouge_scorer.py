...
ROUGE-1.5.5.pl -e data -n 3 -a settings.xml
Or with use_stemmer=True:
ROUGE-1.5.5.pl -m -e data -n 3 -a settings.xml
...
from wassos.eval.metrics.google_rouge import tokenize, scoring
...
def _create_ngrams(tokens, n):
    ...
    Args:
      ...
      n: Number of tokens to use, e.g. 3 for bigrams.
    Returns:
