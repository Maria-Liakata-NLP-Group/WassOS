...
from wassos.data_pipelines.assemblers import assemble_vocab_pipeline
...
def create_tag(vocab_fp, data_path, sep='\t'):
    """Creates a word vocabulary using a simple pipeline."""
    vocab_pipeline = assemble_vocab_pipeline(text_fname=InpDataF.REV_TAG,
                                             sep=sep)
    words_vocab = Vocabulary(vocab_pipeline, name_prefix="tags")
...
if __name__ == '__main__':
    ...
    create_tag(**vars(parser.parse_args()))
